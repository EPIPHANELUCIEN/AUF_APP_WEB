...
<div></div>
  ...
  <center>
    <h1 class="t">Vous trouverez ici le formulaire a remplire pour vous inscrire</h1>
        ...
        <div class="pub">
            <img src="../images/form/51372.jpg" alt="">
       
            <img src="../images/form/537201.jpg" alt="">
      
            <img src="../images/form/knCLgMx-wallpapers-1920x1080.jpg" alt="">
        
            <img src="../images/form/s8xfONO-1920x1080-wallpapers.jpg" alt="">
    ...
    <div class="collapse" id="collapseExample">
        ...
        <div class="containera" >
            ...
            <form action="liste.php" method="post">
              ...
              <input type="text" id="" name="date_de_naissance" placeholder="votre date de naissance ..">

              <label for="lname">Entrez la date de début abonnement</label>
              <input type="text" id="" name="date_de_debut_abonnement" placeholder="Date .."   id="you">
...
<p>
    ...
    <a class="btn btn-primary"  href="../page/tableau.php"   role="button"  aria-controls="collapseExample">
      Voir le Tablaau
      <a ></a>
    </a>
