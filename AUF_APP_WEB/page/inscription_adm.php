<!DOCTYPE html>
    ...
    <body>
        ...
        <section class="header">
          <div >
              <a href="../page/inscription_adm.php">
...
<section class="formula">
  <form class="modal-content formula1" action="liste2.php" method="post">
    <div class="container">
      ...
      <div class="clearfix lol1">
        ...
        <button  class="lol k"><a href="./autentification_adm.php" >Se connecter</a></button>
      </div>
